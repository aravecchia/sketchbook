    ...
    while (client.connected()) 
    {
      if (client.available()) 
      {
        ...
        if (c == '\n' && currentLineIsBlank) 
        {
          ...
          {
            float sensorMovel = map(analogRead(2), 0, 1023, altura-4, 0); // mapeia a variavel de leitura do sensor entre 0 e 100, para facilitar a leitura na tela
            float valorMovel = map(analogRead(2), 0, 1023, 100, 0); //para manipular o valor da barra horizontal, esta deve atualizar a cada leitura do sensor
            float sensorFixo = map(analogRead(2), 0, 1023, altura-4, 0); // mapeia a variavel de leitura do sensor entre 0 e 100, para facilitar a leitura na tela
            float valorFixo = map(analogRead(2), 0, 1023, 100, 0); //para manipular o valor da barra horizontal, esta deve atualizar a cada leitura do sensor

            // BARRA VERTICAL - LEITURA
            client.print("<rect x=");
            client.print(4+(20*x));
            client.print(" y=");
            client.print(((altura+40)*2)+40-sensorMovel-x0); //ninja! \o/
            client.print(" width=20 height=");
            client.print(sensorMovel);
            ...
            client.print(4+(20*x));
            client.print(" y=");
            client.print(((altura+40)*2)+80-sensorFixo-x0); //ninja! \o/
            client.print(" width=20 height=");
            client.print(sensorFixo);
            client.print(" stroke=#000000 stroke-width= 1");
            if (valorFixo>50)
            {
              client.print(" fill=#00ff00 />");
            ...
            client.print(6+(20*x));
            client.print(" y= ");
            client.print(((altura+55)*2)+25);
            client.print(" font-size=8pt style=fill:white;stroke:none>");
            client.print(int(valorMovel));
            client.print("</text>");
            
            client.print("<text x=");
            client.print(6+(20*x));
            client.print(" y= ");
            client.print(((altura+55)*3)+50);
            client.print(" font-size=8pt style=fill:white;stroke:none>");
            client.print(int(valorFixo));
            client.print("</text>");

              float ganho=(100*(sensorMovel/sensorFixo))-100;
            ...
            client.print(4+(20*x));
            client.print(" y= ");
            client.print(600); //ninja! \o/
            client.print(" width=20 height=");
            client.print(int(ganho));
            client.print(" stroke=#FF0000 stroke-width= 1");
